...
require("dotenv").config();// you ensure that the environment variables defined in the .env file are loaded into the Node.js process environment, making them accessible throughout your application via process.env. This allows you to securely manage sensitive configuration settings or other environment-specific values outside of your codebase.
const mongoose = require("mongoose");
const clc = require("cli-color");
const bcrypt = require("bcrypt");
const validator = require("validator");
const session = require("express-session");//generating the session and storing the session in the client side
const mongoDbsession = require("connect-mongodb-session")(session);//to tell the location where the store is created(to locate the store) name of thw store
...
app.listen(PORT, () => {
  ...
  console.log(clc.yellowBright.underline.bold(`http://localhost:${PORT}/register`));
});
